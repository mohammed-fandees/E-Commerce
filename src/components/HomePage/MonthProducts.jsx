    ...
    <div>
      ...
      <div className="body">
        ...
        <div className={`flex justify-between items-center h-[550px] w-full bg-black my-25 lg:ps-15 relative px-4 text-center md:text-left`}>
          ...
          <img src="/products/jbl-outdoor-speaker.png" alt="jpl speaker" className={`w-[55%] mx-25  ${!isRTL && `-scale-x-100`} ${isMobile && "lg:w-[60%] md:w-[70%] w-[80%] h-auto absolute !m-0 left-1/2 -translate-x-1/2 opacity-70"}  [filter:drop-shadow(0px_0px_100px_rgba(255,255,255,_.35))]`} />
        </div>
      </div>
    </div>
  )
